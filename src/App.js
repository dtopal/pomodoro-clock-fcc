  ...
  render() {
    return(
      <div class="container text-center">
        < TimerDisplay timer={this.state.timer} startStop={this.startStopTimer} reset={this.reset} break={this.state.break} />
  ...
  return(
    <div class="wrapper">
      ...
      <div class="row justify-content-center">
        <button class="btn btn-light" id="start_stop" onClick={props.startStop}><i class="fa fa-play" aria-hidden="true" /><i class="fa fa-pause" aria-hidden="true" /></button>
        <button class="btn btn-light ml-1" id="reset" onClick={props.reset}><i class="fa fa-refresh" aria-hidden="true" /></button>
      </div>
